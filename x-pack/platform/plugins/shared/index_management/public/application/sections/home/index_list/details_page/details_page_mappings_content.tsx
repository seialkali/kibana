...
import { EisUpdateCallout } from '@kbn/search-api-panels';
import {
  getStateWithCopyToFields,
  hasElserSemanticTextField,
  isSemanticTextField,
...
export const DetailsPageMappingsContent: FunctionComponent<{
  ...
  const hasEisSemanticText = hasElserSemanticTextField(state.mappingViewFields);
            ...
            {hasEisSemanticText && (
              <>
                <EisUpdateCallout
                  ...
                  promoId="searchSolutionIndexMappings"
